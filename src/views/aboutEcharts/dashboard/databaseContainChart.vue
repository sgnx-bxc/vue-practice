<template>
  <div class="databaseContainChart-page">
    <chartTool
  ...
  methods: {
    initCharts(data) {
      if (data && data.length > 0) {
        ...
        maskImage.src = require('@/assets/img/aboutEcharts/heart_icon.png')
        this.optionData = {
          tooltip: {
            show: true,
            confine: true,
        ...
        const myChart = this.$refs.databaseContainChartRef.getChartInstance()
        myChart.clear()
